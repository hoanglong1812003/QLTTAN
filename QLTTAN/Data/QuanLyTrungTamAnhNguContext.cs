...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Taikhoan>(entity =>
        {
            ...
            entity.HasIndex(e => e.Magv, "DANGNHAPGV_FK");

            entity.HasIndex(e => e.Mahv, "DANGNHAPHV_FK");

            entity.HasIndex(e => e.Manv, "DANGNHAPNV_FK");
            ...
            entity.HasOne(d => d.MagvNavigation).WithMany(p => p.Taikhoans)
                .HasForeignKey(d => d.Magv)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_TAIKHOAN_DANGNHAPG_GIANGVIE");

            entity.HasOne(d => d.MahvNavigation).WithMany(p => p.Taikhoans)
                .HasForeignKey(d => d.Mahv)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_TAIKHOAN_DANGNHAPH_HOCVIEN");

            entity.HasOne(d => d.ManvNavigation).WithMany(p => p.Taikhoans)
                .HasForeignKey(d => d.Manv)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_TAIKHOAN_DANGNHAPN_NHANVIEN");
        });
